"""
Prompt Version: K1_2 (Multilingual)

Key differences from other prompt versions:
- Adds TARGET_LANGUAGE support across 6 prompts (research_agent_prompt,
  transform_messages_into_research_topic_human_msg_prompt, lead_researcher prompt,
  compress_research_system_prompt, compress_discovery_system_prompt,
  SUBTOPIC_GENERATION_PROMPT). This enforces all agent output is written in the
  language detected from the user's messages.
- transform_messages_into_research_topic_human_msg_prompt instructs the LLM to
  identify and return a target_language field from the user's messages.
...
Set PROMPT_VERSION = "K1_2" in config.py to activate this version.
"""
