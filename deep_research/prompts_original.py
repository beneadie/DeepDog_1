...
- No TARGET_LANGUAGE support. Language handling is casual — SUBTOPIC_GENERATION_PROMPT
  includes a note to "write in the same language as the human messages" but no
